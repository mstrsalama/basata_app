document.addEventListener("DOMContentLoaded", () => {
  ...
  if (data.subscriptionType === "telegram") {
    ...
    message += `
      ...
      <p>
      لو عندك مشكلة في مادة <strong>الدراسات الاجتماعية</strong> للمرحلة الإعدادية أو <strong>التاريخ</strong> للمرحلة الثانوية
    </p>
    <p>
      احجز مع <strong>مس إنجي سلامة</strong> على الرقم <strong>01282410636</strong> وانسى المشكلة
    </p>

      <p>مكان السنتر بجوار سوبر ماركت مترو</p>
