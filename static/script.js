...
;  // ✅ لا تعرض المواعيد إلا لو الاشتراك "center"
  ...
  const schedule = {
    "1اعدادي": isBoy
      ? { days: "الأحد - الأربعاء", times: [ "8 م"] }
      : { days: "الأحد - الأربعاء", times: [ "5 م", "6 م"] },
    ...
    "3اعدادي": isBoy
      ? { days: "السبت 8.5 ص -الاتنين -الخميس", times: [ "11 ص"] }
      : { days: "السبت 10 ص و 11.5 ص يحدد لاحقا - الاثنين - الخميس", times: [ "5 م", "6 م"] },
